        ...
        <div class="form-vertical">\
            <div class="control-group">\
                <div class="control-label">\
                    <label for="vmvideo-url"><?php echo $modal_label_url; ?></label>\
                </div>\
                <div class="controls">\
            ...
            <div class="control-group">\
                <div class="control-label">\
                    <label for="vmvideo-ratio"><?php echo $modal_label_ratio; ?></label>\
                </div>\
                <div class="controls">\
            ...
            <div class="control-group">\
                <div class="control-label">\
                    <label for="vmvideo-title"><?php echo $modal_label_title; ?></label>\
                </div>\
                <div class="controls">\
